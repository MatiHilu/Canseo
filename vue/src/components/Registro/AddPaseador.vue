<template>
  <div class="general">
    ...
    <form @submit.prevent="agregarPaseador">
      ...
      <div class="form-group">
        <!--<input type="text" id="descripcion" v-model="descripcion" required placeholder="Descripción">-->
...
export default {
  ...
  this.foto_perfil = event.target.files[0];
    ...
    agregarPaseador() {
      ...
      console.log("Datos enviados al backend:", Object.fromEntries(nuevoPaseador));
